...
already ships with a number of [concrete implementations](../../src/PriceSystem)
...
> The simplest price system is [`Pimcore\Bundle\EcommerceFrameworkBundle\PriceSystem\AttributePriceSystem`](../../src/PriceSystem/AttributePriceSystem.php) 
...
> of [`\Pimcore\Bundle\EcommerceFrameworkBundle\PriceSystem\PriceSystemInterface`](../../src/PriceSystem/PriceSystemInterface.php) 
