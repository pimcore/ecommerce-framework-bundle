...
With OpenSearch it is possible to index all attributes of [Classification Store](https://github.com/pimcore/pimcore/blob/11.x/doc/05_Objects/01_Object_Classes/01_Data_Types/15_Classification_Store.md) 
...
with OpenSearch, it is not activated by default. Following steps are necessary to activate it: 
...
FilteSelectClsStoreAttributes:
    filter_type_id: Pimcore\Bundle\EcommerceFrameworkBundle\FilterService\SearchIndex\SelectClassificationStoreAttributes
